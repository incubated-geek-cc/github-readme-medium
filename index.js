...
app.get("/", (req, res) => {
	...
	res.status(200).send(`<div>
					...
					<div class='container-md'>
				      <h2>Running Express on <a href='https://vercel.com/' target='_blank'>Vercel</a></h2> 
				      <h3>Usage: Retrieve latest <a href='https://medium.com/' target='_blank'>Medium</a> posts</h3>
